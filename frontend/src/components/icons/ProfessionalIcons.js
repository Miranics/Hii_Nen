// Professional icon components to replace emoji icons
...
// Beaker icon (replaces 🔬)
export const ResearchIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} fill="none" stroke={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547A1.07 1.07 0 014 16.5v4.25C4 21.44 4.56 22 5.25 22h13.5c.69 0 1.25-.56 1.25-1.25V16.5a1.07 1.07 0 00-.244-.757zM12 7a2 2 0 100-4 2 2 0 000 4z" />
...
export const AchievementIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} fill="none" stroke={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const GrowthIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} fill="none" stroke={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
// Briefcase icon for business planning
export const BusinessIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} fill="none" stroke={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v6a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0H8m0 0H4a2 2 0 00-2 2v6a2 2 0 002 2h4m4-6v6m0-6V4a2 2 0 00-2-2H10a2 2 0 00-2 2v2" />
  </svg>
);

// Shield icon for validation
...
// Chat bubble icon for mentorship
...
// Launch icon for deployment/startup
export const LaunchIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} fill="none" stroke={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
  </svg>
);
...
export {
  ...
  FundingIcon as Funding,
  ResearchIcon as Research,
  NetworkingIcon as Networking,
  AchievementIcon as Achievement,
  GrowthIcon as Growth,
  StarIcon as Star,
  LearningIcon as Learning,
  BusinessIcon as Business,
  ValidationIcon as Validation,
  MentorshipIcon as Mentorship,
